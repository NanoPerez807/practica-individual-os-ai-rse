...
with open("../resultados/enlaces.txt", "w", encoding="utf-8") as out:
    ...
    for nombre_archivo in xmls:
        ...
        for link in enlaces:
            if link != "https://github.com/kermitt2/grobid" and link != "https://raw.githubusercontent.com/kermitt2/grobid/master/grobid-home/schemas/xsd/Grobid.xsd" and link != "http://www.tei-c.org/ns/1.0" and link !>                out.write(link + "\n")
